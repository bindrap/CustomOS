...
To complete the server environment setup, run:

    cd ~/custom-setup && bash post-install.sh

This will install:
  • Python, Docker, Java, Node.js
...
echo "  4. Run the server setup:"
echo -e "     ${GREEN}cd ~/custom-setup && bash post-install.sh${NC}"
echo ""
echo -e "${YELLOW}The post-install script will:${NC}"
echo "  • Install Python, Docker, Java, Node.js"
echo "  • Configure SSH server and firewall"
echo "  • Install Tailscale VPN"
echo "  • Apply server performance tuning"
