...
DISK_FILE="$DISK_DIR/customos-jan12-xfce.qcow2"
DISK_SIZE="50G"
...
QEMU_ARGS+=(
    ...
    # Better window title
    -name "CustomOS Jan12 XFCE - $([ "$BOOT_MODE" = "cdrom" ] && echo 'Installation' || echo 'Installed System')"
)
